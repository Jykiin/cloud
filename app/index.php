...
<html>
  ...
  <body>
    ...
    <nav class="shadow border border-2 border-primary flex align-items-center justify-content-center">
      <a class="my-2 btn btn-primary w-50" href="/">Accueil</a>
      <a class="my-2 btn btn-primary w-50" href="src/sign-in.php">Inscription</a>
      <a class="my-2 btn btn-primary w-50" href="src/sign-up.php">Connexion</a>
  </nav>
</div>
